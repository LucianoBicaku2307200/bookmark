...
function Checkbox({
  ...
  return (
    <CheckboxPrimitive.Root
      data-slot="checkbox"
      className={cn(
        // The dark background is scoped to the unchecked state: as `dark:bg-input/30`
        // it ties on specificity with the checked background and wins on source order,
        // leaving a dark check icon on a dark box.
